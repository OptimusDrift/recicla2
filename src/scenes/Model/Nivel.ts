...
export default class Nivel {
    ...
    constructor(pantallaDeJuego: any, fondo: string, player: Player, puntajeNecesario: number, monedas: Array<Moneda>, obstaculos: Array<Obstaculo>, recipientes: Array<Recipiente>, residuos: Array<Residuo>, estadoDelNivel: number, monedasRecogidas: number, musica: Musica){
